        ...
        return (
            <span className="uk-margin-left uk-margin-top">
                <div className="uk-form-file">
                    <a type="file" className={"uk-button"}><i className="uk-icon-file-zip-o" title="file"/> Upload Canvas gradesheet
                    </a>
        ...
        */
        ...
        return <div className="uk-flex uk-flex-wrap uk-margin-top">
            <div className="uk-flex uk-flex-column uk-flex-middle uk-margin-left uk-panel uk-panel-box">
                <div>
                    Upload a Canvas gradebook to be amended with OpenTA results
              </div>
                {this.renderUpload()}
              ...
              {!this.props.processingDone && this.renderProcessingProgress()} */}
                ...
                {this.props.processingStatus !== '' &&
                    <Alert>{this.props.processingStatus}</Alert>
                }
                {this.props.processingDone && this.props.processingStatus == 'Complete' && this.renderDownloadResult(this.props.processingTaskId)}
