...
export default class QuestionLinearAlgebra extends Component {
  ...
  return (
        <div className="">
          <label className="uk-form-row uk-display-inline-block"><MathSpan>{this.props.renderText(question.getIn(['text']))}</MathSpan> <span className="uk-text-small uk-text-primary">{availableVariables}</span>
