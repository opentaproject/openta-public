...
<div id={this.id} className="uk-hidden">
  ...
  <p>
I svarsfältet kan man använda de vanliga algebraiska operatorerna *, /, +, - och ^ tillsammans med paranteser för att gruppera uttryck. Förutom dessa operatorer finns de vanligaste funktionerna: sin, sinh, arcsin, arcsinh, cos, cosh, arccos, arccosh, tan, tanh, arctan, arctanh, sqrt (kvadratrot), abs (absolutbelopp), ln (naturliga logaritmen) och log.</p>
