...
const BaseAuditOverview = ({menuPath, audits, pendingAudits, onAuditClick, activeAudit, activeExercise, exerciseName}) => {
...
const mapStateToProps = state => ({
  ...
  exerciseName: state.getIn(['exerciseState', state.get('activeExercise'), 'json', 'exercise', 'exercisename', '$'], ''),
