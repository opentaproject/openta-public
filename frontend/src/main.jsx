...
// Ensure optional globalInit fields exist when injected server-side
if (typeof window.globalInit === 'undefined') {
  window.globalInit = {};
}
if (typeof window.globalInit.source_url === 'undefined') {
  window.globalInit.source_url = 'https://github.com/opentaproject/openta';
}
