...
import { fetchExerciseHistoryList, fetchExerciseXMLHistory } from '../fetchers.js';

import { setExerciseModifiedState } from '../actions.js';
    ...
    return (
      <div data-uk-dropdown="{mode:'click'}">
        <span
          ...
          title="Snapshot history of XML"
          data-uk-tooltip
          onClick={() => this.props.onHistory(this.props.exercise)}
        >
          History
        </span>
        <div className="uk-dropdown" style={{ width: 'auto' }}>
          {items.size == 0 && <span>Empty</span>}
...
const handleItemClick = (exercise, name) => (dispatch) => {
  return dispatch(fetchExerciseXMLHistory(exercise, name)).then(() =>
