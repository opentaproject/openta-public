...
import { setActiveCourse } from '../actions.js';

import { fetchExercises, fetchExerciseTree, fetchAllExerciseStatistics } from '../fetchers.js';
...
const BaseCourseSelect = ({ courses, activeCourse, onCourseChange }) => {
  ...
  return (
    <div className="ChooseCourseToShow uk-button-dropdown" data-uk-dropdown="{mode:'click'}">
