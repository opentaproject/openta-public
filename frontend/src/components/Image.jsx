      ...
      <div className="uk-width-1-1" ref={(node) => (this.container = node)}>
        {this.props.src && (
          <div className="uk-button-group">
            <button className="uk-button uk-button-small" onClick={this.onRotateLeft}>
              <i className="uk-icon uk-icon-rotate-left" />
            </button>
            <button className="uk-button uk-button-small" onClick={this.onRotateRight}>
              <i className="uk-icon uk-icon-rotate-right" />
            </button>
            <button className="uk-button uk-button-small" onClick={this.onZoomOut}>
              <i className="uk-icon uk-icon-search-minus" />
            </button>
            <button className="uk-button uk-button-small" onClick={this.onZoomIn}>
              <i className="uk-icon uk-icon-search-plus" />
            </button>
            <a className="uk-button uk-button-small" href={this.props.src}>
              <i className="uk-icon uk-icon-file-photo-o" />
            </a>
          </div>
        )}
