...
const BaseFooter = ({ student, exerciseState, onHome, author, displaystyle }) => {
  ...
  return (
    <div className="footer uk-align-center uk-margin-remove uk-padding-remove uk-grid uk-width-1-1 uk-child-width-1-6 uk-align-center">
      <div className="uk-padding-remove uk-width-1-6">
        {' '}
        <button className="uk-button  uk-width-1-1 brand onHome" onClick={onHome}>
          {' '}
      ...
      <div className="uk-padding-remove uk-width-1-6">
        {' '}
        <button className="uk-button uk-width-1-1 uk-visible-toggle-@s" data-uk-toggle="{target:'.login-info'}">
      ...
      <div className="uk-padding-remove uk-width-1-6">
        ...
        >
          {' '}
          {sum01}:{sum02}:{sum03}:{sum04}{' '}
        </button>{' '}
      </div>
      <div className="uk-padding-remove uk-width-1-6">
        {' '}
        <button data-uk-tooltip="delay:1500; pos: right" title={mess1} className="uk-button   uk-width-1-1 gold">
          {' '}
