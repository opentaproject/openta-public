...
const BaseUpdateExerciseFilter = ({ exercisefilter, onExerciseFilterChange, activeCourse }) => {
  ...
  return (
    <a
      onClick={() => onExerciseFilterChange(exercisefilter, activeCourse, filter_toggle)}
      title="Toggle between showing and hiding unpublished"
    >
...
const mapDispatchToProps = (dispatch) => {
  ...
  return {
    onExerciseFilterChange: (exercisefilter, activeCourse, filter_toggle) => {
      ...
      cookies.set('exercisefilter', exercisefilter, { path: '/', secure: true , sameSite: 'none' });
