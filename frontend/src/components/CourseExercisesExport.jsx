...
const BaseCourseExercisesExport = ({ onExportExercises, coursePk, taskId, progress, done, status }) => {
  return (
    <div className="uk-flex uk-flex-wrap uk-margin-top">
      <div className="uk-flex uk-flex-column uk-flex-middle uk-margin-left uk-panel uk-panel-box">
        <div>Download a zip file to back up exercises of this course. Store it in a safe location. </div>
        <div>
...
export default connect(mapStateToProps, mapDispatchToProps)(BaseCourseExercisesExport);
