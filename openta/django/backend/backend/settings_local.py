...
PGHOST = os.environ.get("PGHOST", PGHOST )
PGPASSWORD = os.environ.get("PGPASSWORD", PGPASSWORD)
...
OPENTA_VERSION = get_version_string()
#OPENTA_VERSION = "%s-%s-%s" % (OPENTA_VERSION, POD_NAME, NODE_NAME)
