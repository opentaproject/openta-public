...
#DATABASES = {'default': {'ENGINE': 'django.db.backends.postgresql', 'NAME': 'opentadefault1', 'USER': 'postgres', 'PASSWORD': PGPASSWORD, 'HOST': 'localhost', 'PORT': 5432, 'ATOMIC_REQUESTS': False, 'AUTOCOMMIT': True, 'CONN_MAX_AGE' : CONN_MAX_AGE, 'CONN_HEALTH_CHECKS': CONN_HEALTH_CHECKS ,  'OPTIONS': {}, 'TIME_ZONE': None, 'TEST': {'CHARSET': None, 'COLLATION': None, 'MIGRATE': True, 'MIRROR': None, 'NAME': None}}, \
#        'sites': {'ENGINE': 'django.db.backends.postgresql', 'NAME': 'sites', 'USER': 'postgres', 'PASSWORD': PGPASSWORD, 'HOST': 'localhost', 'PORT': 5432, 'ATOMIC_REQUESTS': False, 'AUTOCOMMIT': True,   'CONN_HEALTH_CHECKS': CONN_HEALTH_CHECKS , 'CONN_MAX_AGE' : CONN_MAX_AGE , 'OPTIONS': {},  'TEST': {'CHARSET': None, 'COLLATION': None, 'MIGRATE': True, 'MIRROR': None, 'NAME': None}},\
#        'opentasites': {'ENGINE': 'django.db.backends.postgresql', 'NAME': 'opentasites', 'USER': 'postgres', 'PASSWORD': PGPASSWORD, 'HOST': 'localhost', 'PORT': 5432, 'ATOMIC_REQUESTS': False, 'AUTOCOMMIT': True, 'CONN_MAX_AGE' : CONN_MAX_AGE , 'CONN_HEALTH_CHECKS': CONN_HEALTH_CHECKS, 'OPTIONS': {}, 'TEST': {'CHARSET': None, 'COLLATION': None, 'MIGRATE': True, 'MIRROR': None, 'NAME': None}} 
#             }
