...
class Test5_Matrix(TestCase, MatrixQuestionOps):
    ...
    def test_validate_matrix_entries(self) :
        ...
        question1 =  "<question key=\"key2\"> <iscorrect>g[1,2] </iscorrect> <istrue>$$ == g[1,2] </istrue> <istrue> $$ == ( [1,2] )[2] </istrue> <istrue>( [ $$ , $$  ] )[1]  == ( [ g[1,1] , g[1,2]]  )[2] </istrue> <expression>2 </expression> </question>"
