...
"""
This is the server side implementation of the question type textbased.
"""
...
def question_check_textbased(question_json, question_xmltree, answer_data, global_xmltree):
    ...
    # result = textbased(studentanswerdict, questiondict, globaldict)
...
def textbased_json_hook(safe_question, full_question, question_id, user_id, exercise_key, feedback=False, *args, **kwargs ):
...
def textbased_runner(studentanswerdict, questiondict, globaldict, result_queue):
    try:
...
#    return safe_run(textbased_runner, args=(studentanswerdict, questiondict, globaldict))
...
register_question_type("textbased", question_check_textbased, question_check_textbased, default_validate_question, textbased_json_hook)
