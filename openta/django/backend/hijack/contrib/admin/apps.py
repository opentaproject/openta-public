    ...
    def ready(self):
        ...
        try:
            ...
            if issubclass(UserModelAdmin, HijackUserAdminMixin):
                logger.debug("UserModelAdmin already is a subclass of HijackUserAdminMixin.")
            else:
                ...
                HijackUserModelAdmin = type(UserModelAdmin.__name__, (HijackUserAdminMixin, UserModelAdmin), {})
