...
urlpatterns = [
    ...
    url(r'^exercises/movefolder/$', views.exercises_movefolder),
    url(r'^exercises_movefolder/$', views.exercises_movefolder),
    url(r'^exercises/renamefolder/$', views.exercises_renamefolder),
    url(r'^exercises_renamefolder/$', views.exercises_renamefolder),
