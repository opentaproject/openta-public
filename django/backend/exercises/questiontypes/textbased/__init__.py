...
def textbased_json_hook(safe_question, full_question, question_id, user_id, exercise_key):
...
register_question_type('textbased', question_check_textbased, textbased_json_hook)
