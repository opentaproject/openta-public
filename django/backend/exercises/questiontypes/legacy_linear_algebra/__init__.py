'''
This is the server side implementation of the question type legacy_linearAlgebra.
'''
...
import logging
from .legacy_linear_algebra import legacy_linear_algebra_expression
from .legacy_linear_algebra import legacy_linear_algebra_expression_blocking
...
def question_check_legacy_linear_algebra(
    ...
    result = {}
    result = legacy_linear_algebra_expression(
...
def legacy_linear_algebra_json_hook(safe_question, full_question, question_id, user_id):
...
register_question_type(
    'legacy_linearAlgebra',
    question_check_legacy_linear_algebra,
    legacy_linear_algebra_json_hook,
