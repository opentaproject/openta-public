    ...
    try:
        ...
        try:
            unparsedstudentanswer = sympify_with_custom(
                ascii_to_sympy(student_answer), varsubs_sympify,{},'linear_algebra_compare_expressions'
            )
        except Exception as e:
            test = sympify_with_custom(ascii_to_sympy(student_answer_orig), varsubs_sympify,{},'linear_algebra_compare_expressions').doit()
