...
export default ({ xmlCode, onChange }) => (
  <div className="uk-panel uk-panel-box uk-margin-top" style={{height:"80vh"}}>
    <Codemirror ref={ (instance) => {if(instance != null){window.cm = instance} }} value={xmlCode} options={{mode: 'xml', lineWrapping: true, theme: 'monokai', lineNumbers: true}} onChange={onChange}/> 
  </div>
);
